...
f = open('C:\\Users\\Tom\\Desktop\\car_export.pdb', "a") 
tag = "HETATM"
index = 1
for obj in bpy.data.objects:
    ...
    xcor = round(float(xyz_data[0])*scale_factor,2)
    ycor = round(float(xyz_data[1])*scale_factor,2)
    zcor = round(float(xyz_data[2])*scale_factor,2)
